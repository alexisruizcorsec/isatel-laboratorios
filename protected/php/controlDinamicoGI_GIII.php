								    		...
								    		<div class="card-body">
								    			<table class="table">
								    		 	...
								    		 	<?php 
													...
													$usrG1a = $con -> query("SELECT id,dirEmpresa_R3a,usrNombre_R3a,codeMd5_R3a,fechaHoraFinal_R3a FROM nom035R3a WHERE fechaHoraFinal_R3a LIKE '%$filtroFecha%' ORDER BY id");
													...
													$usrG1aT = $con -> query("SELECT COUNT(usrNombre_R3a) AS totalCol FROM nom035R3a WHERE fechaHoraFinal_R3a LIKE '%$filtroFecha%'");
								    		...
								    		<div class="card-body">
								    			<table class="table">
								    		 	...
								    		 	<?php 
													...
													$usrG3aVsG1a = $con -> query("SELECT usrNombre_R1a FROM nom035R1a WHERE usrNombre_R1a NOT IN(SELECT usrNombre_R3a FROM nom035R3a) AND fechaHoraInicio_R1a LIKE '%$filtroFecha%' ORDER BY usrNombre_R1a");
													$i=0;
													...
													$usrG3aTVSG1 = $con -> query("SELECT COUNT(usrNombre_R1a) AS totalCol FROM nom035R1a WHERE usrNombre_R1a NOT IN(SELECT usrNombre_R3a FROM nom035R3a) AND fechaHoraInicio_R1a LIKE '%$filtroFecha%'");
								    		...
								    		<div class="card-body">
								    			<table class="table">
								    		 	...
								    		 	<?php 
													...
													$usrG1aVsG3a = $con -> query("SELECT usrNombre_R3a FROM nom035R3a WHERE usrNombre_R3a NOT IN(SELECT usrNombre_R1a FROM nom035R1a) AND fechaHoraInicio_R3a LIKE '%$filtroFecha%' ORDER BY usrNombre_R3a");
													$i=0;
													...
													$usrG1aTVSG3a = $con -> query("SELECT COUNT(usrNombre_R3a) AS totalCol FROM nom035R3a WHERE usrNombre_R3a NOT IN(SELECT usrNombre_R1a FROM nom035R1a) AND fechaHoraInicio_R3a LIKE '%$filtroFecha%'");
