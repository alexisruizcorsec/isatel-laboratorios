		 		...
		 		<div class="bg-muted p-3" style="width: 800px;">
		 			<div class="row">
		 				<div class="col-md-10 mx-auto text-center jumbotron">
				 			...
				 			<h3>Resultados Centro de Trabajo y Razón Social G III Matriz</h3>
							...
							while ($centros = $busCentros->fetchArray()) {
								...
								<tr style="text-align: left;">
									<td><a href="../impreR03CentroRazonMatriz/impre.aspx?centro='.$corporativod.'&razonSoc='.$razonSociald.'" target="_blank" rel="noopener noreferrer">'.$corporativod.'</a></td>
									<td><a href="../impreR03CentroRazonMatriz/impre.aspx?centro='.$corporativod.'&razonSoc='.$razonSociald.'" target="_blank" rel="noopener noreferrer">'.$razonSociald.'</a></td>
									<td><a href="../impreR03CentroRazonMatriz/impre.aspx?centro='.$corporativod.'&razonSoc='.$razonSociald.'" target="_blank" rel="noopener noreferrer">'.$cuantos.'</a></td>
								</tr>
