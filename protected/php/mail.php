		 		...
		 		<div class="bg-muted form p-3">
		 			<div class="row">
		 				<div class="col-12 text-center jumbotron">	
				 			...
				 			<h2>¡Te enviamos un correo!</h2>
				 			<br>
				 			<p>
				 				Busca en tu bandeja de entrada <b>confirmacion@corsec.com.mx</b>, es el correo electrónico de confirmación y haz clic en el enlace para activar tu correo.
				 			</p>
