<?php 
			...
			.$resP8ModI.$resP9ModI.$resP10ModI.$resP11ModI.$resP12ModI.$resP13ModI.$resP14ModI.$resP15ModI.$resP16ModI.$resP17ModI.$resP18ModI.$resP19ModI.$resP20ModI.$resP21ModI.
			'<br>Sin embargo, después de haber considerado estos síntomas y con base en  la Guía de Referencia I, inciso b), se identifica que el trabajador no requiere valoración clínica.';
