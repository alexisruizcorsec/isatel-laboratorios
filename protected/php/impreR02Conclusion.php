...
<head>
	...
	<title>Reporte NOM-035 Resultados G2</title>
	<style>
		@media print {
			.hoja{
...
<!-- <body onload="window.print();"> -->
			...
			<div style="padding: 10px; width: 630px; height: 950px; margin: auto;">
				...
				<div style="font-size: .93em;">
					...
					<table>
						...
						<tr>
							<td>Calificación <span style="font-size: .8em;">C<i>final</i></span></td>
	...
	$csCentro = $conPorCentro -> query("SELECT dirEmpresa_R2a FROM nom035R2a GROUP BY dirEmpresa_R2a ORDER BY dirEmpresa_R2a");
	...
	while ($CCentros = $csCentro->fetchArray()) {
		...
		include 'cResul01tDosMas.php';
		include 'cResul02tDosMas.php';
		include 'cResul03tDosMas.php';
